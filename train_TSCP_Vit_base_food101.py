...
if __name__ == "__main__":
    ...
    mix_up = Mixup(mixup_alpha=mixup_alpha, cutmix_alpha=cutmix_alpha, cutmix_minmax=None, prob=1, switch_prob=0.5,
                   label_smoothing=label_smoothing, mode="batch", num_classes=num_classes)
    ...
    for epoch in range(1, epochs + 1):
        ...
        scheduler.step()
    torch.save(model, f"TSCP_Vit_base_{epochs}_Food101.pth")
